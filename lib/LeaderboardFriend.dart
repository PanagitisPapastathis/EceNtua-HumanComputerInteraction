...
class LeaderboardFriend extends StatelessWidget {
  const LeaderboardFriend({super.key});
          ...
          */
          ...
          const Positioned(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                ImageButton_3('General'),
                SizedBox(width: 25),
                ImageButton_2('Friends'),
              ],
            ),
          ),
