...
class Riddle1_text extends StatelessWidget {
  const Riddle1_text({super.key});
...
class ImageButton extends StatelessWidget {
  ...
  ImageButton(this.label, {super.key});
              ...
              Center(
                child: Row(
                  ...
                  children: [
                    SizedBox(
                      width: 300,
                      height: 81, // Adjust the width as needed
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'Write here your answer', // Your hint text
                          hintStyle: TextStyle(
